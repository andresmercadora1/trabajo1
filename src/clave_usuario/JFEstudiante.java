...
public class JFEstudiante extends javax.swing.JFrame {
  ...
  Nodo sig;
  String a,b,c,d,e;
  public Nodo(String a,String b,String c,String d,String e,Nodo w){
  this.a=a;
   this.b=b;
    this.c=c;
     this.d=d;
  ...
  public void i(String a,String b,String c,String d,String e){
  ini=new Nodo(a, b, c, d,e,  ini);
  }
  public void m(){
  Nodo r=ini;
      while (r!=null) {
          JOptionPane.showMessageDialog(null, "["+r.a+"]\n"+"["+r.b+"]\n"+"["+r.c+"]\n"+"["+r.d+"]\n"+"["+r.e+"]\n");
          r=r.sig;
      }
  }
  }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "INGENIERIA DE SISTEMA", "AQUITERTURA", "COMUNICACION SOCIAL", "PUBLICIDAD", "PSICOLOGIA", "DERECHO" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String nom,tel,apell,carr,b;
       nom=txtNombre.getText();
       apell=txtApellido.getText();
       tel=txtTelefono.getText();
       carr=jComboBox1.getSelectedItem().toString();
    b=jComboBox2.getSelectedItem().toString();
      
        Lista l=new Lista();
        
        l.i(nom,apell, tel, carr,b);
        l.m();
